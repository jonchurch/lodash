...
lodashStable.each(['xor', 'xorBy', 'xorWith'], function (methodName) {
  ...
  QUnit.test(
    '`_.' + methodName + '` should return the symmetric difference of two arrays',
    function (assert) {
      assert.expect(1);
  ...
  QUnit.test(
    '`_.' + methodName + '` should return the symmetric difference of multiple arrays',
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test(
    '`_.' + methodName + '` should return an empty array when comparing the same array',
    function (assert) {
      assert.expect(1);
  ...
  QUnit.test(
    '`_.' + methodName + '` should return a new array when a single array is given',
    function (assert) {
      assert.expect(1);
